...
// These migrations received previously deployed comment-only clarifications or
// newline normalization. The audited hashes cover their historical LF/CRLF byte
// forms and the exact source archived for the July 27 staging release. The
// executable SQL in that archive matches the current migrations, so the ledger
// can move once to the canonical checksums without accepting executable changes.
const legacyEquivalentChecksums = new Map([
  ...
  [
    'migration:009_scribeless_fulfillment_lifecycle.sql',
    new Set([
      'be1b2d632c899e7b19b0020388e1a4ee359c6dd6000723dd86be0e98a32526fc',
    ]),
  ],
  [
    'migration:010_public_card_links.sql',
    new Set([
      'c5119988287e0caddc68182505fcef6a2b1822598bdc6498e756e6546512dc29',
    ]),
  ],
]);
