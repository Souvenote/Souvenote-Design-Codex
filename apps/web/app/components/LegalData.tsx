...
const LEGAL_DATA: Record<LegalDataKey, LegalDocData> = {
  cookie: {
    ...
    title: (
      <>
        Cookie <span className="pg-italic text-metallic-gold">Policy</span>
      </>
    ),
    lastUpdated: 'June 1, 2026',
    intro:
      'This Cookie Policy explains how Souvenote uses cookies and similar technologies, the choices you have, and how to manage them.',
    sections: [
      {
        id: 'what-are-cookies',
      ...
      },
      {
        ...
        paras: ['We group the cookies we set into four categories:'],
        bullets: [
          'Essential: keep the site working and your session secure.',
          'Preferences: remember choices like currency and language.',
  ...
  refund: {
    ...
    title: (
      <>
        Refund <span className="pg-italic text-metallic-gold">Policy</span>
      </>
    ),
    lastUpdated: 'June 1, 2026',
    ...
    sections: [
      ...
      },
      {
        ...
        paras: ['The following purchases generally qualify for a refund:'],
        bullets: [
          'Unprinted digital credits within a set window.',
          'Orders cancelled before they enter production.',
  ...
  terms: {
    ...
    title: (
      <>
        Terms of <span className="pg-italic text-metallic-gold">Service</span>
      </>
    ),
    lastUpdated: 'June 1, 2026',
    intro:
      'These Terms of Service govern your use of Souvenote. By creating an account or using the site, you agree to them.',
    sections: [
      {
        id: 'acceptance',
      ...
      },
      {
        ...
        paras: ['When using Souvenote, you agree to the following:'],
        bullets: [
          'Don\u2019t upload content you don\u2019t have rights to.',
          'Don\u2019t use the service for unlawful purposes.',
          'Don\u2019t attempt to disrupt or reverse-engineer the platform.',
        ],
      },
      {
        id: 'payments',
  ...
  privacy: {
    ...
    title: (
      <>
        Privacy <span className="pg-italic text-metallic-gold">Policy</span>
      </>
    ),
    lastUpdated: 'June 1, 2026',
    ...
    sections: [
      {
        ...
        bullets: [
          'Account details you provide, like name and email.',
          'Content you upload, such as photos and messages.',
