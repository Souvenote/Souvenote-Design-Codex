    ...
    <div className="auth-gate-wrap" role="dialog" aria-modal="true">
      ...
      <div className="auth-gate-card">
        ...
        <div className="auth-gate-actions">
          <Link className="bmc-cta" href={authHref('/signup', returnTo)}>
            {primaryLabel}
          </Link>
          <Link className="bmc-cta-secondary" href={authHref('/login', returnTo)}>
            {secondaryLabel}
          </Link>
        </div>
        <Link className="auth-gate-link" href="/pricing">
          View card and credit pricing
        </Link>
      </div>
    </div>
  );
