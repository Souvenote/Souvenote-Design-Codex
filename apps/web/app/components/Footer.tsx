...
const SOCIAL: SocialLink[] = [
  ...
  {
    label: 'TikTok',
    path: 'M16.6 5.82A4.28 4.28 0 0 1 13.8 3h-3v12.4a2.6 2.6 0 0 1-2.6 2.6 2.6 2.6 0 0 1-2.6-2.6A2.6 2.6 0 0 1 8.2 12.8c.28 0 .56.04.82.12V9.84A5.59 5.59 0 0 0 8.2 9.6 5.6 5.6 0 0 0 2.6 15.2a5.6 5.6 0 0 0 5.6 5.6 5.6 5.6 0 0 0 5.6-5.6V9.74a7.28 7.28 0 0 0 4.2 1.34V8.08a4.28 4.28 0 0 1-1.4-2.26z',
  },
  {
    label: 'Snapchat',
    path: 'M12 2c3.4 0 5.5 2.4 5.5 5.6 0 1.1-.1 2-.1 2.7.1.1.4.3.8.3.5 0 1.3-.3 1.8-.4l.3 1c-.5.5-2 1-2.6 1.2-.1.6 1.2 2.6 3.3 3.4l-.3 1c-1.5.5-2.5.4-2.9 1.1-.3.6.4 1.4-1.1 1.7-.7.1-1.3-.1-1.9.1-.5.2-1.1 1.1-2 1.5-1.1.6-1.7.6-2.8 0-.9-.4-1.5-1.3-2-1.5-.6-.2-1.2 0-1.9-.1-1.5-.3-.8-1.1-1.1-1.7-.4-.7-1.4-.6-2.9-1.1l-.3-1c2.1-.8 3.4-2.8 3.3-3.4-.6-.2-2.1-.7-2.6-1.2l.3-1c.5.1 1.3.4 1.8.4.4 0 .7-.2.8-.3 0-.7-.1-1.6-.1-2.7C6.5 4.4 8.6 2 12 2z',
  },
  {
    label: 'Pinterest',
    path: 'M12 2a10 10 0 0 0-3.6 19.3c-.1-.8-.2-2 0-2.9.2-.8 1.1-5 1.1-5s-.3-.6-.3-1.4c0-1.3.8-2.3 1.7-2.3.8 0 1.2.6 1.2 1.3 0 .8-.5 2-.8 3.1-.2.9.5 1.7 1.4 1.7 1.7 0 2.9-2.2 2.9-4.8 0-2-1.3-3.4-3.8-3.4-2.7 0-4.5 2-4.5 4.3 0 .8.2 1.4.6 1.9.2.2.2.3.1.6 0 .2-.2.6-.2.8-.1.3-.3.4-.6.3-1.4-.6-2-2.1-2-3.8 0-2.8 2.4-6.2 7-6.2 3.7 0 6.2 2.7 6.2 5.6 0 3.8-2.1 6.6-5.2 6.6-1 0-2-.5-2.3-1.2l-.6 2.5c-.3 1-.9 2-1.2 2.6A10 10 0 1 0 12 2z',
  },
  {
    label: 'Facebook',
  ...
  {
    label: 'LinkedIn',
    path: 'M4.98 3.5a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5zM3 9.5h4v11H3v-11zM10 9.5h3.8v1.5h.1a4.16 4.16 0 0 1 3.75-2.06c4 0 4.75 2.64 4.75 6.08V20.5h-4v-4.86c0-1.16-.02-2.65-1.62-2.65-1.62 0-1.87 1.27-1.87 2.57V20.5H10v-11z',
  },
];
...
const FOOTER_COLS: FooterColumn[] = [
  ...
  {
    title: 'Company',
    items: ['About', 'Contact', 'FAQ', 'Terms of Service', 'Privacy Policy', 'Cookie Policy', 'Refund Policy'],
  },
];
              ...
              <ul>
                {col.items.map((item) => {
                  ...
                  return (
                    <li key={item}>
                      {href === null ? (
                        <span className="souv-footer-link is-disabled" aria-disabled="true">
                          {item}
                        </span>
                      ) : (
