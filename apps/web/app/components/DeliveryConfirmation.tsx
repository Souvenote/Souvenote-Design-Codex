          ...
          <div className="bmc-card dlv-section" style={{ maxWidth: 760, margin: '0 auto' }}>
            ...
            <div className="co-confirm-rows" style={{ marginTop: 18 }}>
              <div className="co-confirm-row">
                ...
                <span className="co-confirm-row-v">{flowState.orderStatus || 'Not started'}</span>
              </div>
              <div className="co-confirm-row">
                <span className="co-confirm-row-k">Order ID</span>
                <span className="co-confirm-row-v">{shortId(flowState.orderId)}</span>
              </div>
              <div className="co-confirm-row">
                <span className="co-confirm-row-k">Card draft</span>
                <span className="co-confirm-row-v">{shortId(flowState.cardDraftId)}</span>
              </div>
              <div className="co-confirm-row">
                <span className="co-confirm-row-k">Selected asset</span>
                <span className="co-confirm-row-v">{shortId(flowState.selectedAssetId)}</span>
              </div>
              <div className="co-confirm-row">
                <span className="co-confirm-row-k">Checkout session</span>
                <span className="co-confirm-row-v">{shortId(flowState.checkoutSessionId)}</span>
              </div>
              <div className="co-confirm-row">
                <span className="co-confirm-row-k">Payment</span>
                <span className="co-confirm-row-v">{shortId(flowState.paymentId)}</span>
              </div>
              <div className="co-confirm-row">
                <span className="co-confirm-row-k">Fulfillment</span>
                <span className="co-confirm-row-v">
                  {shortId(flowState.fulfillment?.mockFulfillmentId || flowState.fulfillment?.id)}
                </span>
              </div>
            </div>
