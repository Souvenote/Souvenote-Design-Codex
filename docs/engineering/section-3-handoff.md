...
- Exact final-head CI is recorded in docs/engineering/section-3-audit.md after publication.
...
- None. Lyria duration/provider activation and all real checkout/fulfillment remain deferred.
