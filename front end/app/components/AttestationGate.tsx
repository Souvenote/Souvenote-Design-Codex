...
const ATTG_TERMS: LegalSection[] = [
  ...
  ['8. Data retention',
   'Uncommitted uploads are scheduled for deletion after one day, failed or rejected creative assets after 30 days, and abandoned drafts after 90 days of inactivity. Approved cards and songs remain available while your account is active unless you delete them. Account deletion includes a 30-day recovery grace period. Delivery addresses are scheduled for redaction after 180 days. Minimized financial, tax, and order evidence may be retained for six years from the end of the last related tax year, and information used for a decision affecting you is retained for at least one year where required. Deletion may take up to 35 additional days to propagate through encrypted backups and noncurrent object versions.'],
...
const ATTG_PRIVACY: LegalSection[] = [
  ...
  ['5. Data retention',
   'Uncommitted uploads are scheduled for deletion after one day, failed or rejected creative assets after 30 days, and abandoned drafts after 90 days of inactivity. Approved cards and songs remain in your library while your account is active unless you delete them. Account deletion includes a 30-day recovery grace period. Delivery addresses are scheduled for redaction after 180 days, while minimized financial, order, privacy-decision, and safety records are kept for required legal periods. Deletion may take up to 35 additional days to propagate through encrypted backups and noncurrent object versions.'],
